...
for comp in "${components[@]}"; do
    ver="${comp}_VERSION"
    eval "${comp}_URL=\"https://github.com/AvadoDServer/DNP_${comp}/releases/download/v${!ver}/${comp,,}.dnp.dappnode.eth_${!ver}.tar.xz\""
    eval "${comp}_YML=\"https://github.com/AvadoDServer/DNP_${comp}/releases/download/v${!ver}/docker-compose-${comp,,}.yml\""
    eval "${comp}_ENV=\"https://github.com/AvadoDServer/DNP_${comp}/releases/download/v${!ver}/${comp,,}.dnp.dappnode.eth.env\""
    eval "${comp}_MANIFEST=\"https://github.com/AvadoDServer/DNP_${comp}/releases/download/v${!ver}/dappnode_package.json\""
...
echo -e "\e[32mDownloading AVADO Core...\e[0m"
dappnode_core_download
...
cp ./.avado_profile dappnode/DNCORE